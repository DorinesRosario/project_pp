...
for file in $input_files/*.K2505.predictions; do
	base=`basename $file .K2505.predictions`
	python mcc_script.py $input_files/$base.features $input_files/$base.K2505.predictions $output_files/$base.mcc.txt
