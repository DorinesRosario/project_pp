#!/bin/bash
input_files=/home/rosario/Desktop/project_pp/6.psi-blast/psi-blast_svm_format/input/
output_files=/home/rosario/Desktop/project_pp/6.psi-blast/psi-blast_svm_format/output/
